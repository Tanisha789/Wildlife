	...
	<div class="animal-container">
       <!-- Animals -->
        <div class="animal-card">
            ...
            <div class="animal-name">Rhino</div>
            <div class="animal-description">
             <textarea  name="contentRhino">
                   <jsp:scriptlet>
		           ps1.setInt(1,3);
             ...
             <textarea  name="contentMonkey">
              <jsp:scriptlet>
		        ...
		        while(rs5.next())
		        {
		        	...
		        	out.println(rs5.getString("description"));
